...
<form method="post" action="">
    <table class="table table-bordered dTableR">
        <thead>
            <th colspan="2" class="header-table">Thêm tin tức</th>
        </thead>
        <tbody>
        	<? if(isset($error['date'])) {?>
        	<tr>
        	...
        	<tr>
                ...
                <td>
                    ...
                    <? while($row_pt=mysql_fetch_assoc($pt)) {?>
                    	<option value="<?=$row_pt['idNT']?>"><?=$row_pt['name_vn']?></option>
                    <? }?>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                <td>Tóm tắt VN</td>
                <td><textarea name="sum_vn" style="width:60%" placeholder="Tóm tắt VN"><? if(isset($_POST['sum_vn'])) echo $_POST['sum_vn'];?></textarea></td>
            </tr>
            <tr>
                <td>Tóm tắt EN</td>
                <td><textarea name="sum_en" style="width:60%" placeholder="Tóm tắt EN"><? if(isset($_POST['sum_en'])) echo $_POST['sum_en'];?></textarea></td>
            </tr>
            <tr>
                <td>Nội dung VN</td>
                <td>
