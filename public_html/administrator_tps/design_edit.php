<?
...

	{
		...
		$success=$i->editDesign($idDe,&$error);
...
<form method="post" action="">
    ...
    <table class="table table-bordered dTableR">
        ...
        <thead>
            ...
            <th colspan="2" class="header-table">Sửa bài viết Sản phẩm</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
					...
					?>
                    	...
                    	<option value="<?=$row_dt['idDT']?>" <?=$s?>><?=$row_dt['name_vn']?></option>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" placeholder="Hình" name="img" id="img" value="<?=$row_it['img']?>">
