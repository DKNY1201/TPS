        	...
        	<div class="col-md-9">
                <div class="col-md-4 col-sm-6">
                    <div class="profile-box">
                        <a href="Nang-Luc/Catalogue/View/" target="_blank"><img class="img-responsive" src="img/upload/images/Gioi-Thieu/catalogue-bia.jpg" ></a>
                        <a href="Nang-Luc/Catalogue/View/" target="_blank"><h1 class="imp-f">Catalogue</h1></a>
                    </div><!-- end profile-box -->
                </div><!-- end col-md-4 -->
            </div><!-- end col-md-9 -->
