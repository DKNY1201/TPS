...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname="[Truong Phu Steel]")
{
      ...
      $smtp_host ='bitas.com.vn:8383/webmail/';//Dia chi mail server
      $admin_email = 'quytran@bitas.com.vn';//User duoc khai bao tren mail server
      $smtp_username = 'quytran@bitas.com.vn';//User duoc khai bao tren mail server
      $smtp_password = 'P@123456';//Pass cua email nay
...
//Test send mail
SendMail("quytran@bitas.com.vn","quytran@bitas.com.vn","Details of Booking Form","Content Testing");
