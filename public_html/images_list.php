        	...
        	<div class="col-md-9 col-sm-9">
            	...
            	<div class="col-lg-6 col-md-6">
                	...
                	<div class="images-item">
                    	...
                    	<a href="Gioi-Thieu/Hinh-Anh/<?=$row_img['url']?>/"><img class="img-responsive" src="<?=$row_img['img']?>" alt="nha thep tien che, xay dung nha xuong, ket cau thep, pre engineered steel buildings, steel building, tps" title="<?=$row_img['name_'.$lang]?>" ></a>
